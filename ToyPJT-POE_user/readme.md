...
### POE 프로젝트를 진행하면서 배운점
  ...
  - 시각화 능력의 중요성은 의외로 중요하다. 말하고자 하는 말을 내 의도대로 잘 전달할 수 있는 좋은 화술과도 같다.
  - 기간을 정해놓고 진행하자. 지지부진한 부분이나 능력적으로 진행이 어려울 경우 그를 위해 빠져서 공부하는 것이 잘못된 것은 아니지만 할 수 있는(진행해도 되는) 다른 부분부터 하는 것이 시간을 잘 쓸 수 있다.
